...
Block* BlockManager::blocks[BlockID::TOTAL_BLOCKS] = {
	...
	new Block{ "Oak log",			7,  {{  7,  7,  8,  8,  7,  7 }, 
										 {  7,  7,  7,  7,  8,  8 },
										 {  8,  8,  7,  7,  7,  7 }}, { 0, 0, 0, 0, 0, 0 }, SOLID,  0.f, false, true, false, true, true },
	...
	new Block{ "Birch log",			32, {{ 32, 32, 33, 33, 32, 32 }, 
										 { 32, 32, 32, 32, 33, 33 },
										 { 33, 33, 32, 32, 32, 32 }}, { 0, 0, 0, 0, 0, 0 }, SOLID,  0.f, false, true, false, true, true },
	new Block{ "Birch leave",		34, {{ 34, 34, 34, 34, 34, 34 }, { }, { }}, { 0, 0, 0, 0, 0, 0 }, SOLID,  0.f, true, true, false, true, false },
	new Block{ "Jungle log",		35, {{ 35, 35, 36, 36, 35, 35 },
										 { 35, 35, 35, 35, 36, 36 },
										 { 36, 36, 35, 35, 35, 35 }}, { 0, 0, 0, 0, 0, 0 }, SOLID,  0.f, false, true, false, true, true },
