...
void TextRenderer::update(Player* player) {
	...
	std::string renderDistance = "Render distance: " + std::to_string(RENDER_DISTANCE);
	...
	_gameInfos = {
		Text(title,				15.f, Window::getHeight() - 30.f),
		Text(time,				15.f, Window::getHeight() - 60.f),
		Text("",				15.f, Window::getHeight() - 90.f),
		Text(facing,			15.f, Window::getHeight() - 120.f),
		Text(positionXYZ,		15.f, Window::getHeight() - 150.f), 
		Text(blockPositionXYZ,  15.f, Window::getHeight() - 180.f),
		Text(chunkPositionXYZ,	15.f, Window::getHeight() - 210.f),
		Text(renderDistance,	15.f, Window::getHeight() - 240.f),
		Text("",				15.f, Window::getHeight() - 270.f),
		Text(chunksLoaded,		15.f, Window::getHeight() - 300.f),
		Text(vertices,			15.f, Window::getHeight() - 330.f),
		Text(indices,			15.f, Window::getHeight() - 360.f)
	};
}
