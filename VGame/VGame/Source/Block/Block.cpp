...
Block* BlockUtil::blocks[AMOUNT_OF_BLOCKS] = {
	...
	new Block{ "Cactus",		{ 13, 13, 15, 14, 13, 13 }, 10.f, 0.f, FLORA,  true, true },
	...
	new Block{ "Dead bush",		{ 22, 22, 22, 22, 22, 22 },  0.f, 0.f, FLORA,  true, true },
	new Block{ "Grass2",		{ 23, 23, 23, 23, 23, 23 },  0.f, 0.f, FLORA,  true, true }
};
