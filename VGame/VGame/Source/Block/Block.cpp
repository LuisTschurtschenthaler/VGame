...
Block* BlockUtil::blocks[AMOUNT_OF_BLOCKS] = {
	// Name, { RIGHT, LEFT, TOP, BOTTOM, FRONT, BACK }, texturePixelOffset, LL, meshType, isFloraBlock, hasHitbox
	new Block{ "",				{ },						0.f,  0.f,    -1, false, false  },
	new Block{ "Water",			{  0,  0,  0,  0,  0,  0 }, 0.f,  0.f, FLUID, false, false  },
	new Block{ "Lava",			{  1,  1,  1,  1,  1,  1 }, 0.f, 15.f, FLUID, false, false  },
	...
	new Block{ "Oak leave",		{  9,  9,  9,  9,  9,  9 }, 0.f,  0.f, SOLID, true, true  },
	...
	new Block{ "Dead bush",		{ -1, -1, -1, -1, 22, 22 }, 0.f,  0.f, SOLID, true, false },
	new Block{ "Grass",			{ -1, -1, -1, -1, 23, 23 }, 0.f,  0.f, SOLID, true, false },
	new Block{ "Tall grass",	{ -1, -1, 24, 25, -1, -1 }, 0.f,  0.f, SOLID, true, false },
	new Block{ "TNT",			{ 27, 27, 28, 26, 27, 27 }, 0.f,  0.f, SOLID, false, true  },
	new Block{ "Dandelion",		{ -1, -1, -1, -1, 29, 29 }, 0.f,  0.f, SOLID, true, false },
	new Block{ "Poppy",			{ -1, -1, -1, -1, 30, 30 }, 0.f,  0.f, SOLID, true, false },
	new Block{ "Blue Orchid",	{ -1, -1, -1, -1, 31, 31 }, 0.f,  0.f, SOLID, true, false },
